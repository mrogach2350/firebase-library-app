...
const PROD_MESSAGING_ID = '386662561878'
...
firebase.initializeApp({
  ...
  messagingSenderId: !STAGE_MESSAGING_ID || self.location.hostname.includes('react-library-app-f0182')
    ? PROD_MESSAGING_ID
    : STAGE_MESSAGING_ID
})
/* eslint-disable prettier/prettier */
...
messaging.setBackgroundMessageHandler(function (payload) {
  ...
  const notificationTitle = 'Firebase-library-app'
